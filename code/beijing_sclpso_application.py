...
class Config:
    ...
    DATA_PATH: str = "/public/home/sszzkli/.local/Step2/beijing.csv"
    OUT_ROOT: str = "/public/home/sszzkli/.local/Step2/beijing_sclpso_individual_model_outputs"
    ...
    OPT_MAX_FES: int = 0  # 0 => OPT_PARTICLES * OPT_ITERATIONS
...
def _city_method_color_map() -> Dict[str, str]:
    return {
        "SVR": "#1f77b4",                 # blue
        "SCLPSO-SVR": "#ff7f0e",          # orange
        "RandomForest": "#2ca02c",        # green
        "SCLPSO-RandomForest": "#d62728", # red
        "ExtraTrees": "#9467bd",          # purple
        "SCLPSO-ExtraTrees": "#8c564b",   # brown
        "MLP": "#17becf",                 # cyan
        "SCLPSO-MLP": "#e377c2",          # magenta
    }
...
def plot_city_four_metrics(application_df: pd.DataFrame, out_root: Path):
...
def main():
    ...
    plot_city_four_metrics(application_df, out_root)
